...
class DocumentsTest {
    ...
    void userProfileTest() {
        ...
        documents.setUserProfile(userProfileBack);
        assertThat(documents.getUserProfile()).isEqualTo(userProfileBack);

        documents.userProfile(null);
        assertThat(documents.getUserProfile()).isNull();
    }
}
