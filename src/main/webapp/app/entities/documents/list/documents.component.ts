...
import { DocumentsService, EntityArrayResponseType } from '../service/documents.service';
...
export class DocumentsComponent implements OnInit {
  ...
  trackId = (item: IDocuments): number => this.documentsService.getDocumentsIdentifier(item);
