...
import { sampleWithRequiredData } from '../trademark-class.test-samples';
...
describe('TrademarkClass Management Component', () => {
  let comp: TrademarkClassComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TrademarkClassComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.trademarkClasses()[0]).toEqual(expect.objectContaining({ id: 17567 }));
  });

  describe('trackId', () => {
    it('should forward to trademarkClassService', () => {
      const entity = { id: 17567 };
      jest.spyOn(service, 'getTrademarkClassIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTrademarkClassIdentifier).toHaveBeenCalledWith(entity);
