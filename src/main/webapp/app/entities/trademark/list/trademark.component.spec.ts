...
describe('Trademark Management Component', () => {
  let comp: TrademarkComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, TrademarkComponent],
      providers: [
        {
      ...
      .overrideTemplate(TrademarkComponent, '')
      .compileComponents();
