...
import { sampleWithRequiredData } from '../phonetics.test-samples';
import { PhoneticsService } from '../service/phonetics.service';

import { PhoneticsComponent } from './phonetics.component';
import SpyInstance = jest.SpyInstance;

describe('Phonetics Management Component', () => {
  let comp: PhoneticsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, PhoneticsComponent],
      providers: [
        {
      ...
      .overrideTemplate(PhoneticsComponent, '')
      .compileComponents();
