 ...
 */
@RestController
@RequestMapping("/api/extended/tm-agents")
public class TmAgentResourceExtended {

    private static final Logger log = LoggerFactory.getLogger(TmAgentResourceExtended.class);
