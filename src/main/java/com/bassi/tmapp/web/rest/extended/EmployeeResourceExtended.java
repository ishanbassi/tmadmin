...
import com.bassi.tmapp.service.EmployeeQueryService;
import com.bassi.tmapp.service.EmployeeService;
...
/**
 * REST controller for managing {@link com.bassi.tmapp.domain.Employee}.
 */
@RestController
@RequestMapping("/api/extended/employees")
public class EmployeeResourceExtended {

    private static final Logger LOG = LoggerFactory.getLogger(EmployeeResourceExtended.class);
    ...
    public EmployeeResourceExtended(
