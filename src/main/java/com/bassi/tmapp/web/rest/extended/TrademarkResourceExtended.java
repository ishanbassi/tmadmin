 ...
 */
@RestController
@RequestMapping("/api/extended/trademarks")
public class TrademarkResourceExtended {

    private static final Logger log = LoggerFactory.getLogger(TrademarkResourceExtended.class);
