...
import com.bassi.tmapp.service.EmailAlreadyUsedException;
...
@Service
@Transactional
public class UserServiceExtended {

    private static final Logger log = LoggerFactory.getLogger(UserServiceExtended.class);
