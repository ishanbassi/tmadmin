...
public class TmAgentServiceExtended {
    ...
    TmAgentServiceExtended(
        TmAgentRepositoryExtended tmAgentRepositoryExtended,
        TrademarkRepository trademarkRepository,
        TrademarkMapper trademarkMapper,
        TmAgentMapper tmAgentMapper,
    ...
    public void saveTmAgents(List<PublishedTmDTO> trademarks) {
        ...
        List<TmAgent> newAgents = agentNames
            .stream()
            .filter(agentName -> {
            ...
            .map(agentName -> {
                ...
                trademarkByAgentName.get(agentName).stream().findFirst().ifPresent(tm -> newAgent.setAddress(tm.getAgentAddress()));
                return newAgent;
            })
            .toList();
    ...
    private void assignAgentsToPublishedTrademarks(Map<String, List<PublishedTmDTO>> trademarkByAgentName, List<TmAgent> agents) {
