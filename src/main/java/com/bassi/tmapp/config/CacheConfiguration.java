...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.bassi.tmapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.bassi.tmapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.bassi.tmapp.domain.User.class.getName());
            createCache(cm, com.bassi.tmapp.domain.Authority.class.getName());
            ...
            createCache(cm, com.bassi.tmapp.domain.TrademarkClass.class.getName() + ".trademarks");
            createCache(cm, com.bassi.tmapp.domain.Payment.class.getName());
            createCache(cm, com.bassi.tmapp.domain.TrademarkPlan.class.getName());
            createCache(cm, com.bassi.tmapp.domain.TrademarkToken.class.getName());
            createCache(cm, com.bassi.tmapp.domain.TokenPhonetic.class.getName());
            createCache(cm, com.bassi.tmapp.domain.TrademarkTokenFrequency.class.getName());
            createCache(cm, com.bassi.tmapp.domain.UserEventsTracking.class.getName());
