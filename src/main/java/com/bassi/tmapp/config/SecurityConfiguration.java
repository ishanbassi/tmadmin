...
import com.bassi.tmapp.security.*;
import com.bassi.tmapp.web.filter.SpaWebFilter;
        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/files/**")).permitAll()
                    ...
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/api/client/**")).permitAll()
                    ...
                    .requestMatchers(mvc.pattern(HttpMethod.POST,"/api/payments/create/*")).permitAll()
